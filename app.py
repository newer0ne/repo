...
st.write('Краткое описание интерфейса: слева - панель рабочих функций, ниже - рабочее поле. '
         'После применения необходимой функции, например, проверки базы данных по АЭС на рабочем поле отображаются результаты применения функции.') 
...
#    st.write(uploaded_file2)
    ...
    st.write('Соответствие опор запрашиваемых в ведомости ОПС на Курскую АЭС. **В правом верхнем углу** отображаемой можно увеличить таблицу **на весь экран**')
    st.write(B)
