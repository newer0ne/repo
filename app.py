...
with st.expander("Каталог KT2"):
    ...
    show_CatKT2 = pd.DataFrame(CatKT2['KT2_mark', 'Обозначение', 'Наименование', 'KT2_diam', 'KT2_mass', 'KT2_Fz_100'])           #'Li_type','Li_diam_class','Li_series','Li_delim','Li_length','Li_diam','KT2_length'
