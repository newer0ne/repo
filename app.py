...
st.sidebar.write("1. Загрузка ведомости опор в формате таблиц excel")
st.sidebar.write("2. Определяемый столбец дожен иметь название Note")
st.sidebar.write("3. Нужно удалить первые два скрытых столбца - таблица должна начинаться со столбца Код KKS")
