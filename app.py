...
st.write('Интерфейс: слева - Модуль классификации ведомостей ОПС, ниже - ссылки на Документацию отдела и Расширения с каталогами.',
         'В расширениях с каталогами доступна функция поиска по исполнениям.') 
